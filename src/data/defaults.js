// Built-in content shown when the backend isn't configured or can't be reached.
// Keep in sync with server/src/seed/defaults.js (the dashboard's source of truth).
